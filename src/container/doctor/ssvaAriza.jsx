...
const SsvAriza = () => {
  ...
  useEffect(() => {
    request
      ...
      .then((data) =>
        setPerson(data.data.data.filter((item) => +item.id === +params.id)[0])
      );
  }, [params.id]);
              ...
              {tab === false ? (
                <TableContainer component={Paper}>
                  ...
                  >
                    ...
                    <TableBody>
                      {person?.vositalar < 0
                        ? person?.vositalar &&
                          person?.vositalar.map((item, index) => (
                            <TableRow>
                ...
                <TableContainer component={Paper}>
                  ...
                  >
                    ...
                    <TableBody>
                      {person?.bildirishnoma &&
                        Object.keys(person?.bildirishnoma.bola).map(
                          (item, index) => (
                            <TableRow>
                              <TableCell align="left">{item}</TableCell>
                              <TableCell align="left">
                                {person.bildirishnoma &&
                                  person?.bildirishnoma.bola[item]}
                              </TableCell>
                            </TableRow>
                          )
                        )}
          ...
          <div className="rol_ariza_bottom_div_inner">
            <div className="rol_ariza_bottom_div_inner_block">
              ...
              <div className="document_left_title_block">
                <p className="document_left_title">{person?.qoshimcha}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="rol_ariza_bottom_div_inner_block">
              ...
              <div className="rol_ariza_bottom_div_t6">
                ...
                >
                  <Button
                    onClick={() =>
                      setActive(person?.fayl === null ? false : true)
                    }
                    variant="contained"
