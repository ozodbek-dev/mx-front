...
const SingleBemor = () => {
  ...
  const [modal, setModal] = useState({ koriklar: false });


	
	const { isLoading } = useGet({
		url: `/muassasa/bola/?filter[id]=${params.id}`,
		onSuccess: res => {
			setBemorIdPro({
				isFetched: true,
  ...
  if (isLoading || !person?.ism) return <Loading />;
  return (
		<>
			<Koriklar open={modal.koriklar} handleClose={() => setModal({ ...modal, koriklar: false })} />
			<div className='singlebemor'>
				<div className='singlebemor_top'>
					<div className='singlebemor_top_left'>
						...
						<Button onClick={() => setModal({ ...modal, koriklar: true })} startIcon={<AccessTimeIcon />} variant='contained'>
							{t("input.kor")}
						</Button>
						<Button
					...
					<div className='singlebemor_block_left'>
						<div className='singlebemor_block_info'>
							...
							<div className='singlebemor_block_info_inner'>
								...
								<h5 className='singlebemor_block_info_desc'>{person.otasining_ismi}</h5>
							</div>
							<div className='singlebemor_block_info_inner'>
							...
							<div className='singlebemor_block_info_inner'>
								...
								<h5 className='singlebemor_block_info_desc'>{person.tugilgan_sana}</h5>
							</div>
							<div className='singlebemor_block_info_inner'>
						...
						<div className='singlebemor_block_info'>
							<h4 className='singlebemor_block_info_title'>{t("sbola.contact")}</h4>
							<div className='singlebemor_block_info_inner'>
								<h5 className='singlebemor_block_info_desc'>{t("shifokor.tel")}</h5>
								<h5 className='singlebemor_block_info_desc'>{person.tel_raqami}</h5>
							</div>
							<div className='singlebemor_block_info_inner'>
								<h5 className='singlebemor_block_info_desc'>{t("bola.qtel")}</h5>
								<h5 className='singlebemor_block_info_desc'>{person?.qoshimcha_raqam?.trim() || t("input.mavjud")}</h5>
							</div>
							<div className='singlebemor_block_info_inner'>
							...
							<div className='singlebemor_block_info_inner'>
								...
								<h5 className='singlebemor_block_info_desc'>{person.manzil_uyi ? person.manzil_uyi : t("Kiritilmagan")}</h5>
							</div>
						</div>
						<div className='singlebemor_block_info'>
							...
							<div className='singlebemor_block_info_inner'>
								...
								<h5 className='singlebemor_block_info_desc'>{`${person.passport_seriya_va_raqami}`}</h5>
							</div>
							<div className='singlebemor_block_info_inner'>
								<h5 className='singlebemor_block_info_desc'>{t("bola.who")}</h5>
								<h5 className='singlebemor_block_info_desc'>{get(person, "qachon_kim_tomonidan_berilgan", t("Kiritilmagan"))}</h5>
							</div>
						</div>
					</div>
					<div className='singlebemor_block_right'>
						<div className='singlebemor_block_info'>
							...
							<div className='singlebemor_block_info_inner'>
								...
								<h5 className='singlebemor_block_info_desc'>{person.biriktirilgan_muassasa.nomi}</h5>
							</div>
							<div className='singlebemor_block_info_inner'>
								<h5 className='singlebemor_block_info_desc'>{t("bola.rxt")}</h5>
								<h5 className='singlebemor_block_info_desc'>{person.royxatga_olingan_sana}</h5>
							</div>
						</div>
						<div className='singlebemor_block_info'>
							...
							<div className='singlebemor_block_info_inner'>
								...
								<h5 className='singlebemor_block_info_desc'>
									{person.otasi.ism} {person.otasi.familiya} {person.otasi.otasining_ismi}
								</h5>
							</div>
							<div className='singlebemor_block_info_inner'>
								<h5 className='singlebemor_block_info_desc'>{t("sbola.on1")}</h5>
								<h5 className='singlebemor_block_info_desc'>
									{person.onasi.ism} {person.onasi.familiya} {person.onasi.otasining_ismi}
								</h5>
							</div>
						</div>
					</div>
						...
						<Fade in={open2}>
							<div style={classes.paper}>
								<div className='delete_g'>
									<h4 style={{ fontSize: "20px" }}>{t("input.bdel")}</h4>
									<div className='izoh_text'>
										<FormControl size='100%' style={{ width: "100%" }}>
											...
											>
												...
												<MenuItem value={"Muassasa almashtirildi"}>Muassasa almashtirildi</MenuItem>
									...
									<div className=''>
										<Stack direction={"row"} gap={"1rem"}>
											<Button
												variant='contained'
												style={{ backgroundColor: "gray", color: "white", fontSize: "12px" }}
								...
								<form className='form_control_scrool' action=''>
									...
									<div className='input_blocks'>
										...
										<div className='select_div select_div_100'>
											<FormControl>
												<InputLabel id='shifokorid'>{t("sidebar.li4")} (FIO)</InputLabel>
												<Select
													labelId='shifokorid'
												...
												>
													{shifokorlar &&
														shifokorlar.map((item, index) => (
															<MenuItem key={index} id={item.shifokor_id} MenuItem value={item.shifokor_id}>
									...
									<div className='input_blocks'>
										<div className='select_div-11'>
											<FormControl>
												<InputLabel id='Status'>{t("bildirishnoma.status")}</InputLabel>
												<Select
													labelId='Status'
													id='demo-simple-select3'
													onChange={onChange}
										...
										<div className='select_div-11'>
											<FormControl>
												...
												>
													...
													<MenuItem value={"Surunkali buyurak kasallanishi"}>Surunkali buyurak kasallanishi</MenuItem>
												</Select>
											</FormControl>
										</div>
									</div>
									<div className='input_blocks'>
										<div className='select_div-11'>
											...
											>
												{diainput.asorati && diainput.asosiy ? "Diagnoz to'ldirildi" : " Diagnoz"}
											</div>
											...
											>
												<Fade in={open1}>
													<div style={classes.paper}>
														...
														<Button variant='contained' color='primary' size='large' onClick={Dializa}>
															Qo'shish
														</Button>
													</div>
												</Fade>
									...
									<label className='custom-file-upload'>
										<input className='upload-file visually-hidden' type='file' onChange={e => File(e)} />
									...
									>
										<input className='upload-file visually-hidden' type='file' onChange={e => setFile(e.target.files[0])} />
									...
									<div className='button_block1'>
										<Button variant='contained' color='primary' size='large' onClick={Heets}>
