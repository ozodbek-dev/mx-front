...
export default function Arizamoh() {
                              ...
                              <TableCell align="center">
                                <div className="button_modal button_modal_1">
                                  <Link
                                    Link
                                    to = {
                                      `/rolarizasssv_birlashtirish/${item.id}`
                                    }
                                    className="single_info"
                                  >
                                    <img
