...
const Rolarizasinglebssvto = () => {
  ...
  const [qosh, setQosh] = useState("");

  function Send() {
    const formmdata = new FormData();
    formmdata.append("mavzu", mavzu);
    formmdata.append("fayl", pass);
    formmdata.append("qoshimcha", qosh);
    // for (var key in checkblock) {
    //   formmdata.append(key, checkblock[key]);
    //   setLoeder(true);
    // }

    request.post(`ariza/moh/yaratish/`, formmdata, config);
    console
        ...
        <div className="t9">
          <div className="rol_ariza_bottom_div_inner">
            <div className="rol_ariza_bottom_div_inner_block">
              <h4 className="rol_ariza_bottom_title">Mavzu</h4>
            ...
            <div className="rol_ariza_bottom_div_inner">
              <div className="rol_ariza_bottom_div_inner_block">
                ...
                <div className="document_left_title_block">
                  <TextareaAutosize
                    className="document_left_title"
                    onChange={(e) => setQosh(e.target.value)}
                  >
                    {person?.qoshimcha}
                  </TextareaAutosize>
                  {/* <p>{person?.qoshimcha}</p> */}
...
export default Rolarizasinglebssvto;
