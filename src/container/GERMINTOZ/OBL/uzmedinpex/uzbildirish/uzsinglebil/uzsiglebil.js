        ...
        {sarf.map((item, index) => (
          <div className="sarflov_block" key={index}>
            ...
            <div className="sarflov_block_inner">
              ...
              {/* <div className="sarflov_block_inner_div">
              <h5 className="sarflov_block_inner_div_title">{t("bildirishnoma.single.muas")}noma.single.muas")}</h5>
              <TextField
                id="outlined-basic"
          ...
          <div className="sarflov_block" style={{ width: "50%" }}>
              ...
              return (
                <>
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <FormGroup className="zayavka-all">
                      <FormControlLabel
                        className="zayavka-all__all"
                        control={<Checkbox />}
                        label={el.prev + "-" + el.next}
                      />
                    </FormGroup>
                    <Button
            ...
            <div style={{ display: "flex", alignItmes: "center" }}>
              {state.length > 4 && (
                <p
                  className={
                    visable ? "zayavka-all__limit--none" : "zayavka-all__limit"
                  }
                >
                  Siz 5 tagacha variant qo'shishingiz mumkin. Yangi variant
                  qo'shish uchun ulardan birini o'chiring
                </p>
              )}
              {state.length > 4 && (
                <Button
