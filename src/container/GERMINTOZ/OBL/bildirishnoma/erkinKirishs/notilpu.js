...
function Notilpu() {
  ...
  const knop = (e) => {
    ...
    request.post("/bildirishnoma/muassasa/erkin/", formData, config);
  };
        ...
        <div className="ariza_top">
          ...
          >
            <h4 className="ariza_top_title">
              {" "}
              {t("bildirishnoma.allariza")}: {data.length}{" "}
            </h4>
            <TextField
                        ...
                        <TableRow>
                          ...
                          <TableCell align="center">
                            <div className="button_modal button_modal_1">
                              <Link
                                onClick={item.status !== "Yuborildi" && knop}
                                to={`/singlelpu/${item.id}`}
