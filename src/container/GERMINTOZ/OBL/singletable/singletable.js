...
const [tab, setTab] = useState(false)
     ...
     useEffect(() =>{
      ...
      .then(data => setPerson(data.data.arizalar.find(el => +el.id === +params.id)))
        ...
        <div className="rol_ariza_bottom_top">
          ...
          <div className="rol_ariza_bottom_bigbox rol_ariza_bottom_bigbox_info_1">
            ...
            <div className="rol_ariza_bottom_block1">
              ...
              <p className="info_single">{person?.vaqti && person.vaqti.slice(0,10)}</p>
            </div>
          </div>
        </div>
            ...
            <div className="single_table_all_block_bottom">
              {
                ...
                <Table className={classes.table} aria-label="customized table">
                  ...
                  <TableBody>
                   {person?.vositalar && person?.vositalar.map((item,index) => (
                      <TableRow>
               ...
               <TableContainer component={Paper}>
                <Table className={classes.table} aria-label="customized table">
                  ...
                  <TableBody>
                    {
                      person?.bildirishnoma && Object.keys(person?.bildirishnoma.bola).map((item,index) => (
                      <TableRow>
                      <TableCell align="left">{item}</TableCell>
                      <TableCell align="left">{person.bildirishnoma && person?.bildirishnoma.bola[item]}</TableCell>
                    </TableRow>
                      ))
                    }
