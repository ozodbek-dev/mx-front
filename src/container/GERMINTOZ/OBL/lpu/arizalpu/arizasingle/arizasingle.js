  ...
  const handleChanges = (event, newValue) => {
    setValue(newValue);
     ...
     const Add = () =>{
       ...
       formData.append("bildirishnoma",person.bildirishnoma)
       request
       .post("/ariza/lpu/bildirishnomatoariza/",formData,config)
       .then(data => setBola(data.data))
     }
        ...
        <div className="rol_ariza_bottom_top rol_ariza_bottom_top2">
          <h4 className="rol_ariza_bottom_title">
           ...
           <div className="status_info" >
            {
                person.status === "Javob berilmadi" && 
                <p className="status_info_title page-status--1" >
                {person.status}
                </p>
            }
            {
                person.status === "Yuborilmadi" && 
                <p className="status_info_title page-status--2" >
                {person.status}
                </p>
            }
        ...
        <div className="rol_ariza_bottom_div_inner">
          ...
          <div className="single_table_all_block">
            ...
            <Tabs style={{marginBottom:"20px",borderBottom:"1px solid"}} value={value} onChange={handleChanges} aria-label="basic tabs example">
                    ...
                    <Tab onClick={Add} label={t("bildirishnoma.single.bolalar")}/>
              </Tabs>
                ...
                <TableContainer component={Paper}>
                  <Table className={classes.table} aria-label="customized table">
                    ...
                    }
                    {
                      ...
                      <TableBody>
                        {
                          bola.bolalar && Object.keys(bola.bolalar).map((el,index) => {
