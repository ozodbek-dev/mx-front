import {Button, Checkbox, FormControlLabel, FormGroup, Snackbar, TextareaAutosize, TextField} from '@mui/material';
      ...
      <form onSubmit={Send}>
          ...
          sarf.map((item, index) => (
            <div className="sarflov_block" key={index}>
              ...
              <div className="sarflov_block_inner">
                <div className="sarflov_block_inner_div">
                  <h5 className="sarflov_block_inner_div_title">
                    {t("bildirishnoma.single.kimdan")} (Yuboruvchining ism sharifi)
                  </h5>
              ...
              />
                ...
                <div className="sarflov_block_inner_div">
                  <h5 className="sarflov_block_inner_div_title">{t("bildirishnoma.vlssv")} ({t("bildirishnoma.send")})</h5>
                  <TextField
                    id="outlined-basic"
                    variant="outlined"
                    name='kimga'
                ...
                <div className="sarflov_block_inner_div">
                  <h5 className="sarflov_block_inner_div_title">{t("bildirishnoma.tuman")}</h5>
                  <TextField
                    id="outlined-basic"
                    variant="outlined"
                    name='kimga'
                ...
                <div className="sarflov_block_inner_div">
                  <h5 className="sarflov_block_inner_div_title">{t("bildirishnoma.single.vositainf")}</h5>
                  <TextField
                    id="outlined-basic"
                    variant="outlined"
                    name='kimga'
        ...
        <div style={{
          ...
          <div className="sarflov_block" style={{ width: "49%" }}>
            <h4 className="sarflov_block_title" style={{ marginBottom: "16px" }}>{t("bildirishnoma.new.boshqa")}</h4>
            <TextField
              style={{ width: "359px", marginRight: "16px", marginTop: "23px" }}
              id="outlined-basic"
              variant="outlined"
