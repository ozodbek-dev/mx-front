...
function Singlebolrmo() {
    ...
    const token = window.localStorage.token
     ...
     useEffect(() =>{
        request
        .get("/bildirishnoma/tuman/", config)
    ...
    return(
      ...
      <div className="single_table_document">
        ...
        <div className="rol_ariza_bottom_div_inner">
            ...
            <ul className="site-list" style={{paddingLeft:"0px"}}>
                {
            ...
            style = {
              {
                ...
                {
                   person.yosh_toifa && person.oy_toifa.split(",").map(el => {
                        return(
                            <li className="site-list__items">
                                   {el} {t("vosita.oy")}
                        </li>
