...
const DoctorExaminations = ({ id, isOpen, handleClose }) => {
  ...
  console.log(
    "🚀 ~ file: doctor-examinations.js:38 ~ DoctorExaminations ~ examination:",
    examination
  );
  console.log(vositalar);
                  ...
                  {examination.map((item, index) => (
                    ...
                    >
                      <div className="doctor-examination-box-header">
                        <h4 className="doctor-examination-box-title">
                          #{index + 1} {t("input.korik")}
                        </h4>
                        <button
                          className="btn"
                      ...
                      <div>
                        <div className="doctor-examination-box-fields">
                          ...
                          <div className="doctor-examination-box-fields-field">
                            {get(item, "korik.created_at")?.split(" ")[0]}
                          </div>
                        </div>
                        <div className="doctor-examination-box-fields">
                          <div className="doctor-examination-box-fields-field">
                          ...
                          <div className="doctor-examination-box-fields-field">
                            {get(item, "korik.created_at")?.split(" ")[1]}
                          </div>
                        </div>
                        <div className="doctor-examination-box-fields">
                          <div className="doctor-examination-box-fields-field">
